...
CREATE UNIQUE INDEX cm_co_voms_provisioner_servers_i1 ON public.cm_co_voms_provisioner_servers USING btree (co_provisioning_target_id);
-- Add Foreign Key constraints
ALTER TABLE ONLY public.cm_co_voms_provisioner_servers
    ADD CONSTRAINT cm_co_voms_provisioner_servers_co_provisioning_target_id_fkey FOREIGN KEY (co_provisioning_target_id) REFERENCES public.cm_co_provisioning_targets (id);
